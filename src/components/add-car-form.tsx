...
const FormInitialSchema = insertCarSchema.omit({ id: true, auctionFee: true, gateFee: true, titleFee: true, environmentalFee: true, virtualBidFee: true, groundFee: true, oceanFee: true, totalFee: true, shippingFee: true, destinationPort: true, });
...
export function AddCarForm() {
  ...
  return (<Form {...form}> <form onSubmit={handleSubmit} className="w-full md:w-2/3 space-y-6 my-4 bg-gray-200/90 dark:bg-gray-700 p-3 rounded-md"> <div className="grid grid-cols-1 lg:grid-cols-4 gap-2"> <FormField control={form.control} name="vin" render={({ field }) => (
    <FormItem>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            }} value={selectedAuctionLocation} required>
              <FormControl>
                <SelectTrigger>
